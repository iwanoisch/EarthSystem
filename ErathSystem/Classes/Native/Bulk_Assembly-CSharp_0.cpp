...
// Spin
struct Spin_t2228728196;
// UnityEngine.Transform
struct Transform_t3600365921;
// spinCloud
struct spinCloud_t1438030164;
// System.Char[]
...
extern "C"  void Spin__ctor_m1305782858 (Spin_t2228728196 * __this, const RuntimeMethod* method)
{
	{
		__this->set_gametimePerDay_2((24.0f));
		MonoBehaviour__ctor_m1579109191(__this, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Spin::Start()
extern "C"  void Spin_Start_m3030363488 (Spin_t2228728196 * __this, const RuntimeMethod* method)
{
	{
		return;
	}
...
extern "C"  void Spin_Update_m1350371954 (Spin_t2228728196 * __this, const RuntimeMethod* method)
{
	float V_0 = 0.0f;
	{
		float L_0 = __this->get_gametimePerDay_2();
		float L_1 = Time_get_deltaTime_m372706562(NULL /*static, unused*/, /*hidden argument*/NULL);
		V_0 = ((float)il2cpp_codegen_multiply((float)((float)((float)(360.0f)/(float)L_0)), (float)L_1));
		Transform_t3600365921 * L_2 = Component_get_transform_m3162698980(__this, /*hidden argument*/NULL);
		float L_3 = V_0;
		NullCheck(L_2);
		Transform_Rotate_m3172098886(L_2, (0.0f), L_3, (0.0f), /*hidden argument*/NULL);
		return;
	}
}
#ifdef __clang__
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void spinCloud::.ctor()
extern "C"  void spinCloud__ctor_m3807284189 (spinCloud_t1438030164 * __this, const RuntimeMethod* method)
{
	{
		__this->set_gametimePerDay_2((96.0f));
		MonoBehaviour__ctor_m1579109191(__this, /*hidden argument*/NULL);
		return;
	}
}
// System.Void spinCloud::Start()
extern "C"  void spinCloud_Start_m4109667255 (spinCloud_t1438030164 * __this, const RuntimeMethod* method)
{
	{
		return;
	}
}
// System.Void spinCloud::Update()
extern "C"  void spinCloud_Update_m1517396877 (spinCloud_t1438030164 * __this, const RuntimeMethod* method)
{
	float V_0 = 0.0f;
	{
		float L_0 = __this->get_gametimePerDay_2();
